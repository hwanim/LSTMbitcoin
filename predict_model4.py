...
train, test = supervised_values[0:round(len(supervised_values)*0.1)], supervised_values[-round(len(supervised_values)*0.1):]
...
# report performance
rmse = sqrt(mean_squared_error(raw_values[-round(len(supervised_values)*0.1):], predictions))
print('Test RMSE: %.3f' % rmse)
# line plot of observed vs predicted
pyplot.plot(raw_values[-round(len(supervised_values)*0.1):])
